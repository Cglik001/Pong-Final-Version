...
function startGame(){
  let gameCanvas = document.getElementsByClassName("full-game")
...
function gameOver() {
  let startDiv = document.getElementByClassName("start")
  let gameCanvas = document.getElementsByClassName("full-game")
  let gameOver = document.getElementByClassName("game-over");
